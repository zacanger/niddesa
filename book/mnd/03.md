...
[MN.16], no three kinds of barrenness [SN.45.166]: the barrenness of greed, the
...
as arrangement, such as kind, wherever has arrived, who is khattiya, or
...
individuals, lives, those born to people, those born to Indra, and Manu.
...
is silent; ...ignorance..., ...resentment.., ...domineering..., (omitted, see
...
view," there are two kinds of fixed views: .... "Proactive," Proactive,
...
There is no place in the world where there are all kinds of views,  
...
are all kinds of (incorrect) views (of existence)": "Cleansing," cleansing is
...
fixed views of seeing (views)... (omitted). "In all kinds of existence," in all
