...
"How after seeing does the bhikkhu reach Nibbāna": How to extinguish one's greed
...
one's ignorance... (omitted, see previous sections), ...all unwholesome deeds,
to annihilate it, calm it, quiet it, calm it down, and stop it. "Bhikkhu," a
bhikkhu, a virtuous bhikkhu, or a learned bhikkhu.
...
Whether inside or outside of theirself,  
Should not have fortitude (stubbornness) because of that,  
Because that is not said to be silence by the righteous.

"Anyone who can prove the knowledge of the Dhamma within theirself": Any one of
...
"They should not maintain a classification of theirself": "They" is called me.
They should not keep constructing, classifying, and arrogantly distinguishing
'me' (theirself).

> 154 &middot; There should be silence only within oneself,  
Bhikkhus should not seek silence from others,  
The person silent within theirself,  
...
are seven types of increase: ...(omitted, see previous sections). "No matter
where," ....
...
"Distresses (dangers)," there are two types of dangers: the obvious danger and
...
"Adjustment of distress," modulation of distress, surrender of distress, death
...
types of self-attachment: ...(omitted, see previous sections). "Any (thing),"
...
"Deception": is called deception. Here, after a certain type of person performs
...
"Should not tremble with accusations": Some people here by birth...(omitted, see
previous sections), or in the heard, or in the debate, or in the rebuke of
...
"Anger," ...(omitted, see previous sections).
...
when they are happy, not when they are suffering, he does not involve theirself
in their affairs and duties.
...
> 165 &middot; Bhikkhus should not be boastful,  
...
braggers, who boast and brag: ...(omitted, see previous sections). In this way
he should not boast, he should not show off. Boasting should be given up, should
be driven away, ....
...
Here, a certain type of survivor of the wonderful life scorns other survivors of
...
precepts and restraints": You should not live with bad practices, or live better
than good, or with wisdom, or restraint, or prohibitions, to contempt and
...
understanding, after weighing, .... Or, the correct path, the path that follows
the path, ...(omitted, see previous sections). After knowing....
...
when distinguishing; when clarifying: "All actions are impermanent"... (omitted,
see previous sections); ...when clarifying." The bhikkhu who selects. "Always,"
.... "Mindfully," .... "Should learn," ....
...
"He who does not let go (relax) should always be respectful and follow his
